...
public class BenchmarkParams extends BenchmarkParamsL4 {
    ...
    public BenchmarkParams(String benchmark, String generatedTarget, boolean synchIterations,
                           ...
                           String dynamicHaltHost, String dynamicHaltPort, String dynamicHaltModel, int forks, int warmupForks,
...
abstract class BenchmarkParamsL2 extends BenchmarkParamsL1 implements Serializable, Comparable<BenchmarkParams> {
    ...
    protected final String dynamicHaltHost;
    protected final String dynamicHaltPort;
    protected final String dynamicHaltModel;
    ...
    /**
     * @return dynamicHaltHost the API host
     */
    public String getDynamicHaltHost() {
        return dynamicHaltHost;
    }

    /**
     * @return dynamicHaltPort the API port
     */
    public String getDynamicHaltPort() {
        return dynamicHaltPort;
    }

    /**
     * @return dynamicHaltModel the API model
     */
    public String getDynamicHaltModel() {
