...
public class OptionsBuilder implements Options, ChainedOptionsBuilder {
    ...
    private Optional<String> dynamicHaltHost = Optional.none();

    @Override
    public ChainedOptionsBuilder dynamicHaltHost(String value) {
        this.dynamicHaltHost = Optional.of(value);
        return this;
    }
    ...
    public Optional<String> getDynamicHaltHost() {
        if (otherOptions != null) {
            return dynamicHaltHost.orAnother(otherOptions.getDynamicHaltHost());
        } else {
    ...
    private Optional<String> dynamicHaltPort = Optional.none();

    @Override
    public ChainedOptionsBuilder dynamicHaltPort(String value) {
        this.dynamicHaltPort = Optional.of(value);
        return this;
    }
    ...
    public Optional<String> getDynamicHaltPort() {
        if (otherOptions != null) {
            return dynamicHaltPort.orAnother(otherOptions.getDynamicHaltPort());
        } else {
    ...
    private Optional<String> dynamicHaltModel = Optional.none();

    @Override
    public ChainedOptionsBuilder dynamicHaltModel(String value) {
        this.dynamicHaltModel = Optional.of(value);
        return this;
    }
    ...
    public Optional<String> getDynamicHaltModel() {
        if (otherOptions != null) {
            return dynamicHaltModel.orAnother(otherOptions.getDynamicHaltModel());
        } else {
