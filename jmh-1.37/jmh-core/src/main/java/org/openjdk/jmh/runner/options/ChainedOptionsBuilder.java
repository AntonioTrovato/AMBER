...
public interface ChainedOptionsBuilder {
    ...
    /**
     * API Host for Dynamic Halt
     * @param host API host.
     * @return builder
     */
    ChainedOptionsBuilder dynamicHaltHost(String host);

    /**
     * API Port for Dynamic Halt
     * @param port API port.
     * @return builder
     */
    ChainedOptionsBuilder dynamicHaltPort(String port);

    /**
     * API Model for Dynamic Halt
     * @param model API model
     * @return builder
     */
    ChainedOptionsBuilder dynamicHaltModel(String model);
