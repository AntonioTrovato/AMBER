...
public interface Options extends Serializable {
    ...
    /**
     * Dynamic Halt API Host
     * @return host
     * @see org.openjdk.jmh.annotations.DynamicHalt
     */
    Optional<String> getDynamicHaltHost();

    /**
     * Dynamic Halt API Port
     * @return port
     * @see org.openjdk.jmh.annotations.DynamicHalt
     */
    Optional<String> getDynamicHaltPort();

    /**
     * Dynamic Halt API Model
     * @return model
     * @see org.openjdk.jmh.annotations.DynamicHalt
     */
    Optional<String> getDynamicHaltModel();
