...
public class BenchmarkResultMetaData implements Serializable {
    ...
    public void addWarmupIterations(int iterations) {
        actual_warmup_iterations.add(iterations);
    }

    public void addMeasurementIterations(int iterations) {
        actual_measurement_iterations.add(iterations);
    }

    public ArrayList<Integer> getActual_warmup_iterations() {
        return actual_warmup_iterations;
    }

    public ArrayList<Integer> getActual_measurement_iterations() {
        return actual_measurement_iterations;
    }
