...
public class BenchmarkListEntry implements Comparable<BenchmarkListEntry> {
    ...
    public BenchmarkListEntry(String userClassQName, String generatedClassQName, String method, Mode mode,
                              ...
                              Optional<String> dynamicHaltHost, Optional<String> dynamicHaltPort, Optional<String> dynamicHaltModel, Optional<Integer> forks, Optional<Integer> warmupForks,
        ...
        this.dynamicHaltHost = dynamicHaltHost;
        this.dynamicHaltPort = dynamicHaltPort;
        this.dynamicHaltModel = dynamicHaltModel;
        this.forks = forks;
    ...
    public BenchmarkListEntry(String line) {
        ...
        this.dynamicHaltHost        = reader.nextOptionalString();
        this.dynamicHaltPort        = reader.nextOptionalString();
        this.dynamicHaltModel       = reader.nextOptionalString();
    ...
    public String toLine() {
        ...
        writer.putOptionalString(dynamicHaltHost);
        writer.putOptionalString(dynamicHaltPort);
        writer.putOptionalString(dynamicHaltModel);
    ...
    public BenchmarkListEntry cloneWith(Mode mode) {
        return new BenchmarkListEntry(userClassQName, generatedClassQName, method, mode,
                ...
                dynamicHaltHost, dynamicHaltPort, dynamicHaltModel, forks, warmupForks,
    ...
    public Optional<String> getDynamicHaltModel() {
        return dynamicHaltModel;
    }
