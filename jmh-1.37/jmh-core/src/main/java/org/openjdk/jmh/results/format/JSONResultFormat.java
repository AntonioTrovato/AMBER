...
class JSONResultFormat implements ResultFormat {
    ...
    public void writeOut(Collection<RunResult> results) {
        ...
        for (RunResult runResult : results) {
            ...
            String dynamicHaltModel = params.getDynamicHaltModel();
            ...
            if(!dynamicHaltHost.isEmpty() && !dynamicHaltPort.isEmpty() && !dynamicHaltModel.isEmpty()) {
                pw.println("\"dynamicHaltHost\" : " + toJsonString(params.getDynamicHaltHost()) + ",");
                pw.println("\"dynamicHaltPort\" : " + toJsonString(params.getDynamicHaltPort()) + ",");
                pw.println("\"dynamicHaltModel\" : " + toJsonString(params.getDynamicHaltModel()) + ",");
            }
            ...
            if(!dynamicHaltHost.isEmpty() && !dynamicHaltPort.isEmpty() && !dynamicHaltModel.isEmpty()) {
                ...
                Iterator<BenchmarkResult> iterator = runResult.getBenchmarkResults().iterator();
                while(iterator.hasNext()) {
                    stringBuilder.append(iterator.next().getMetadata().getActual_warmup_iterations());
                    if(iterator.hasNext())
                        stringBuilder.append(",");
                }
                pw.println(stringBuilder.toString());
                pw.println("],");
                //pw.println("\"originalWarmupIterations\" : " + params.getWarmup().getCount() + ",");
                //pw.println("\"warmupIterations\" : " + runResult.getBenchmarkResults().stream().findFirst().get().getMetadata().getActual_warmup_iterations() + ",");
            }else
            ...
            if(!dynamicHaltHost.isEmpty() && !dynamicHaltPort.isEmpty() && !dynamicHaltModel.isEmpty()) {
                pw.println("\"measurementIterations\" : 100,");
                /*pw.println("\"measurementIterations\" : [");
                StringBuilder stringBuilder = new StringBuilder();
                Iterator<BenchmarkResult> iterator = runResult.getBenchmarkResults().iterator();
                while(iterator.hasNext()) {
                    stringBuilder.append(iterator.next().getMetadata().getActual_measurement_iterations());
                    if(iterator.hasNext())
                        stringBuilder.append(",");
                }
                pw.println(stringBuilder.toString());
                pw.println("],");
                pw.println("\"originalMeasurementIterations\" : " + params.getMeasurement().getCount() + ",");*/
                //pw.println("\"warmupIterations\" : " + runResult.getBenchmarkResults().stream().findFirst().get().getMetadata().getActual_warmup_iterations() + ",");
            }else
