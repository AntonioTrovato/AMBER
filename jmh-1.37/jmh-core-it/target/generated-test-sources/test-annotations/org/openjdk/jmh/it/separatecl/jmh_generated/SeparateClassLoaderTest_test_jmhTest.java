package org.openjdk.jmh.it.separatecl.jmh_generated;
...
import org.openjdk.jmh.it.separatecl.jmh_generated.SeparateClassLoaderTest_jmhType;
public final class SeparateClassLoaderTest_test_jmhTest {
    ...
    public BenchmarkTaskResult test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            SeparateClassLoaderTest_jmhType l_separateclassloadertest0_G = _jmh_tryInit_f_separateclassloadertest0_G(control);
            ...
            while (control.warmupShouldWait) {
                l_separateclassloadertest0_G.test();
                if (control.shouldYield) Thread.yield();
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            test_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_separateclassloadertest0_G);
            ...
            if (control.isLastIteration()) {
                synchronized(this.getClass()) {
                    f_separateclassloadertest0_G = null;
                }
            }
    ...
    public BenchmarkTaskResult test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            test_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_separateclassloadertest0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_separateclassloadertest0_G);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void test_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, SeparateClassLoaderTest_jmhType l_separateclassloadertest0_G) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            test_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_separateclassloadertest0_G);
            control.preTearDown();
    ...
    public static void test_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, SeparateClassLoaderTest_jmhType l_separateclassloadertest0_G) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile SeparateClassLoaderTest_jmhType f_separateclassloadertest0_G;
    
    SeparateClassLoaderTest_jmhType _jmh_tryInit_f_separateclassloadertest0_G(InfraControl control) throws Throwable {
        SeparateClassLoaderTest_jmhType val = f_separateclassloadertest0_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = f_separateclassloadertest0_G;
            if (val != null) {
                return val;
            }
            val = new SeparateClassLoaderTest_jmhType();
            val.readyTrial = true;
            f_separateclassloadertest0_G = val;
            } catch (Throwable t) {
