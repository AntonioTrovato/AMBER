...
import org.openjdk.jmh.it.fails.inherit.jmh_generated.InheritThreadBenchSetupTest_jmhType;
public final class InheritThreadBenchSetupTest_test_jmhTest {
    ...
    public BenchmarkTaskResult test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            InheritThreadBenchSetupTest_jmhType l_inheritthreadbenchsetuptest0_0 = _jmh_tryInit_f_inheritthreadbenchsetuptest0_0(control);
            ...
            while (control.warmupShouldWait) {
                l_inheritthreadbenchsetuptest0_0.test();
                if (control.shouldYield) Thread.yield();
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            test_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_inheritthreadbenchsetuptest0_0);
            ...
            if (control.isLastIteration()) {
                f_inheritthreadbenchsetuptest0_0 = null;
            }
    ...
    public static void test_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, InheritThreadBenchSetupTest_jmhType l_inheritthreadbenchsetuptest0_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            test_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_inheritthreadbenchsetuptest0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_inheritthreadbenchsetuptest0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void test_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, InheritThreadBenchSetupTest_jmhType l_inheritthreadbenchsetuptest0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            test_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_inheritthreadbenchsetuptest0_0);
            control.preTearDown();
    ...
    public static void test_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, InheritThreadBenchSetupTest_jmhType l_inheritthreadbenchsetuptest0_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    InheritThreadBenchSetupTest_jmhType f_inheritthreadbenchsetuptest0_0;
    
    InheritThreadBenchSetupTest_jmhType _jmh_tryInit_f_inheritthreadbenchsetuptest0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        InheritThreadBenchSetupTest_jmhType val = f_inheritthreadbenchsetuptest0_0;
        if (val == null) {
            val = new InheritThreadBenchSetupTest_jmhType();
            val.setup();
            f_inheritthreadbenchsetuptest0_0 = val;
        }
        return val;
    }
