...
import org.openjdk.jmh.it.batchsize.jmh_generated.SingleShotBatchAnn15Test_jmhType;
public final class SingleShotBatchAnn15Test_test_jmhTest {
    ...
    public BenchmarkTaskResult test_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            SingleShotBatchAnn15Test_jmhType l_singleshotbatchann15test0_0 = _jmh_tryInit_f_singleshotbatchann15test0_0(control);

            control.preSetup();
            l_singleshotbatchann15test0_0.setup();


            control.announceWarmupReady();
            while (control.warmupShouldWait) {
                l_singleshotbatchann15test0_0.test();
                if (control.shouldYield) Thread.yield();
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            test_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_singleshotbatchann15test0_0);
            ...
            control.preTearDown();
            l_singleshotbatchann15test0_0.tearDownIter();

            if (control.isLastIteration()) {
                l_singleshotbatchann15test0_0.tearDownTrial();
                f_singleshotbatchann15test0_0 = null;
            }
    ...
    public BenchmarkTaskResult test_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            test_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_singleshotbatchann15test0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult test_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            test_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_singleshotbatchann15test0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void test_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, SingleShotBatchAnn15Test_jmhType l_singleshotbatchann15test0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult test_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            test_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_singleshotbatchann15test0_0);
            control.preTearDown();
            l_singleshotbatchann15test0_0.tearDownIter();
    ...
    public static void test_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, SingleShotBatchAnn15Test_jmhType l_singleshotbatchann15test0_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    SingleShotBatchAnn15Test_jmhType f_singleshotbatchann15test0_0;
    
    SingleShotBatchAnn15Test_jmhType _jmh_tryInit_f_singleshotbatchann15test0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        SingleShotBatchAnn15Test_jmhType val = f_singleshotbatchann15test0_0;
        if (val == null) {
            val = new SingleShotBatchAnn15Test_jmhType();
            f_singleshotbatchann15test0_0 = val;
        }
        return val;
    }
